...
CONF_UNIVERSAL_TRACKING_SCAN = "universal_tracking_scan"
...
DEFAULT_UNIVERSAL_TRACKING_SCAN = False
DEFAULT_UNIVERSAL_SCAN_MAX_MESSAGES = 75
DEFAULT_UNIVERSAL_SCAN_TIMEOUT = 15
